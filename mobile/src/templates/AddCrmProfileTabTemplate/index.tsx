        ...
        {params?.from === 'Vehicle Of Interest' ? (
          <View>
            ...
            <InputBox
              ...
              onChangeText={(value: string) => updateData('trimId', value)}
              borderLess
            ...
            <InputBox
              ...
              onChangeText={(value: string) => updateData('mileage', value)}
              borderLess
              numberOfCharacter={100}
            />
            {/* Color (Ext) */}
            ...
            <InputBox
              ...
              onChangeText={(value: string) => updateData('exteriorColorId', value)}
              borderLess
              numberOfCharacter={100}
            />
            {/* Color (Int) */}
            ...
            <InputBox
              ...
              onChangeText={(value: string) => updateData('interiorColorId', value)}
              borderLess
              numberOfCharacter={100}
            />
            {/* Memo */}
            ...
            <InputBox
              ...
              onChangeText={(value: string) => updateData('memo', value)}
              borderLess
              numberOfCharacter={100}
            />
            <PrimaryButton
          ...
          <View>
            ...
            <InputBox
              ...
              onChangeText={(value: string) => updateData('stock', value)}
              borderLess
              numberOfCharacter={100}
            />
            ...
            <InputBox
              ...
              onChangeText={(value: string) => updateData('vin', value)}
              borderLess
              numberOfCharacter={100}
            />
          ...
          <View>
            ...
            <InputBox
              ...
              onChangeText={(value: string) => updateData('expirationDate', value)}
              borderLess
              numberOfCharacter={100}
            />
            {/* Memo */}
